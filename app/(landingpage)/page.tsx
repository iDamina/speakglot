...
export default function Home() {
  return(
    <div className="max-w-[988px] mx-auto flex-1 w-full flex flex-col lg:flex-row
    items-center justify-center p-4 gap-2">
      ...
      <div className="flex flex-col items-center gap-y-8">
        ...
        max-w-[480px] text-center">
          Learn, practice and master new Nigerian languages with SpeakGlot.
        </h1>
        ...
        max-w-[330px] w-full">
          ...
          <ClerkLoaded>
            <SignedOut>
              ...
              afterSignUpUrl="/learn">
                <Button 
                size="lg" variant="primaryOutline"
                className="w-full">
